    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v1/api/clients/**").hasAuthority("ADMINISTRADOR")
                        .requestMatchers("/v1/api/users/**").hasAuthority("ADMINISTRADOR")
                        .requestMatchers("/v1/api/sales/**").hasAnyAuthority("ADMINISTRADOR", "VENTAS")
                        .requestMatchers("/v1/api/receipts/**").hasAnyAuthority("ADMINISTRADOR", "VENTAS")
                        .requestMatchers("/v1/api/purchase-details/**").hasAnyAuthority("ADMINISTRADOR", "COMPRAS")
