    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v1/api/providers/**").hasAnyAuthority("COMPRAS")
                        .requestMatchers("/v1/api/products/**").hasAnyAuthority("INVENTARIO")
                        .requestMatchers("/v1/api/units/**").hasAnyAuthority("INVENTARIO")
                        .requestMatchers("/v1/api/warehouses/**").hasAnyAuthority("INVENTARIO")
                        .requestMatchers("/v1/api/branches/**").hasAnyAuthority("INVENTARIO")
                        .requestMatchers("/v1/api/purchases/**").hasAnyAuthority("COMPRAS")
